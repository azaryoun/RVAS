<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Smart.Master" CodeBehind="UserEdit.aspx.vb" Inherits="RVAS.UserEdit" %>
         ...
         <uc1:Bootstrap_Panel runat="server" ID="Bootstrap_Panel" />
          ...
          <asp:UpdatePanel ID="UpdatePanel1" runat="server">
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                  ...
                  <!-- Date and time range -->
                    ...
                    <asp:ListItem Value="1" Text="Normal" Selected="false"></asp:ListItem>
            ...
            <div class="col-xs-12">
             ...
             <asp:Image ID="imgUserPhoto" runat="server"  CssClass="user-image img-responsive" ImageUrl="~/Images/System/User.jpg" />
