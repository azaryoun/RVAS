...
Imports System.IO
Public Class OnDemandSystematicSendReport
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            ...
            lnqVASServiceOnDemand = lnqVASServiceOnDemand.Where(Function(x) x.IsSystematic = True).OrderBy(Function(x) x.tbl_VASService.ServiceName)
            ...
            cmbVASServices.Items.Insert(0, "(تمام سرویس های سیستمی)")
    ...
    Private Sub Bootstrap_Panel_Panel_Display_Click(sender As Object, e As EventArgs) Handles Bootstrap_Panel.Panel_Display_Click
        ...
        lnqSendLog = lnqSendLog.Where(Function(x) x.tbl_VASService.IsOnDemand = True AndAlso x.tbl_VASService.tbl_VASServiceOnDemand.IsSystematic = True)
