<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Smart.Master" CodeBehind="ServiceReceiveReport.aspx.vb" Inherits="RVAS.ServiceReceiveReport" %>
         ...
         <uc1:Bootstrap_Panel runat="server" ID="Bootstrap_Panel" />
          ...
          <asp:UpdatePanel ID="UpdatePanel1" runat="server">
               ...
               <div class="form-group has-error">
                      <label  >سرشماره</label>
             <asp:DropDownList ID="cmbHeadNumbers" CssClass="form-control select2" style="width:100%;direction:rtl" runat="server">
                        </asp:DropDownList>       
               </div>
