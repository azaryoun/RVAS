<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Smart.Master" CodeBehind="ServiceSendReport.aspx.vb" Inherits="RVAS.ServiceSendReport" %>
    ...
    <div class="col-xs-12">
         <uc1:Bootstrap_Panel runat="server" ID="Bootstrap_Panel" />
          ...
          <asp:UpdatePanel ID="UpdatePanel1" runat="server">
             ...
             <asp:DropDownList ID="cmbServiceType" CssClass="form-control select2" style="width:100%;direction:rtl" runat="server" AutoPostBack="true" >
                 <asp:ListItem Text="(تمام انواع سرویس)" Value="0" Selected="True"></asp:ListItem>  
                  <asp:ListItem Text="عضویتی خبری" Value="1"></asp:ListItem> 
                  <asp:ListItem Text="عضویتی سریالی" Value="2"></asp:ListItem> 
                  <asp:ListItem Text="برحسب تقاضا دستی" Value="3"></asp:ListItem> 
                  <asp:ListItem Text="برحسب تقاضا سیستمی" Value="4"></asp:ListItem>    
                   </asp:DropDownList>       
               </div>
