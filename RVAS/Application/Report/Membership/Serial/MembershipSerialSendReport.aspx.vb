...
Imports System.IO
Public Class MembershipSerialSendReport
    ...
    Private Sub Bootstrap_Panel_Panel_Display_Click(sender As Object, e As EventArgs) Handles Bootstrap_Panel.Panel_Display_Click
        ...
        lnqSendLog = lnqSendLog.Where(Function(x) x.tbl_VASServiceMembershipSubscriber IsNot Nothing AndAlso x.tbl_VASServiceMembershipSubscriber.tbl_VASServiceMembership.IsNewsContent = False)
        ...
        Else 'Detail
            ...
            Else
                ...
                For Each lnqSendLogListItem In lnqSendLogList
                    ...
                    tbCell = New HtmlTableCell
                    tbCell.NoWrap = False
                    Dim intSerialOrder As Integer = lnqSendLogListItem.SerialOrder
                    tbCell.InnerHtml = intSerialOrder.ToString("n0")
                    tbRow.Cells.Add(tbCell)
                    strCSVFile &= "," & tbCell.InnerHtml
