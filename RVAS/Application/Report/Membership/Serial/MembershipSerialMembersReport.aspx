<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Smart.Master" CodeBehind="MembershipSerialMembersReport.aspx.vb" Inherits="RVAS.MembershipSerialMembersReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group has-error">
               ...
               <asp:DropDownList ID="cmbSubscriptionType" CssClass="form-control select2" style="width:100%;direction:rtl" runat="server">
                        <asp:ListItem Text="(همه حالت ها)" Value="1" ></asp:ListItem>
                        <asp:ListItem Text="اعضای کنونی" Value="2" Selected="True"></asp:ListItem>
                        <asp:ListItem Text="اعضای پیشین" Value="3"></asp:ListItem>
                          </asp:DropDownList>         
               </div>
