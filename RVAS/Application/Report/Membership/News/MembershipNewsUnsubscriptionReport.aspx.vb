...
Imports System.IO
Public Class MembershipNewsUnsubscriptionReport
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            ...
            lnqVASServiceMembershipNews = lnqVASServiceMembershipNews.Where(Function(x) x.IsNewsContent = True).OrderBy(Function(x) x.tbl_VASService.ServiceName)
            ...
            cmbVASServices.Items.Insert(0, "(تمام سرویس های خبری)")
    ...
    Private Sub Bootstrap_Panel_Panel_Display_Click(sender As Object, e As EventArgs) Handles Bootstrap_Panel.Panel_Display_Click
        ...
        lnqVASServiceMembershipSubscriber = lnqVASServiceMembershipSubscriber.Where(Function(x) x.tbl_VASServiceMembership.IsNewsContent = True)

        lnqVASServiceMembershipSubscriber = lnqVASServiceMembershipSubscriber.Where(Function(x) x.UnsubscriptionDate IsNot Nothing AndAlso x.UnsubscriptionDate >= dteFrom AndAlso x.UnsubscriptionDate <= dteTo)
