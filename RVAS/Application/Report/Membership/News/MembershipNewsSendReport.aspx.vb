...
Imports System.IO
Public Class MembershipNewsSendReport
    ...
    Private Sub Bootstrap_Panel_Panel_Display_Click(sender As Object, e As EventArgs) Handles Bootstrap_Panel.Panel_Display_Click
        ...
        lnqSendLog = lnqSendLog.Where(Function(x) x.tbl_VASServiceMembershipSubscriber IsNot Nothing AndAlso x.tbl_VASServiceMembershipSubscriber.tbl_VASServiceMembership.IsNewsContent = True)
