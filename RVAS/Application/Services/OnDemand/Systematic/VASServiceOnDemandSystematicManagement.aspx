<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Smart.Master" CodeBehind="VASServiceOnDemandSystematicManagement.aspx.vb" Inherits="RVAS.VASServiceOnDemandSystematicManagement" %>
                    ...
                    <thead>
                      <tr role="row">
                       ...
                       <th  style="width:5px;" >#</th>
                              <th>عنوان<br />(نوع)</th>
                          <th>تجمیع کننده<br />(شماره)</th>
                             <th>کاربر مالک<br />(تاریخ)</th>
                          <th>Service ID<br />(وضعیت)</th>
                      </tr>
                    </thead>
                    <tbody>
