<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Smart.Master" CodeBehind="VASServiceOnDemandSystematicNew.aspx.vb" Inherits="RVAS.VASServiceOnDemandSystematicNew" %>
            ...
            <div class="form-group has-error">
                ...
                <div class="form-group has-error">
                      ...
                      <asp:DropDownList ID="cmbtheTypeDemand" CssClass="form-control select2" style="width:100%" runat="server" >
                        <asp:ListItem Value="1" Text="کلید ثابت" Selected="True"></asp:ListItem>
