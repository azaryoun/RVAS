...
Public Class VASServiceOnDemandSystematicEdit
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            ...
            Dim lnqVASServiceOnDemandSystematic = OdbVas.tbl_VASServiceOnDemandSystematic.Where(Function(x) x.FK_VASServiceID = inttheKey).FirstOrDefault

            If lnqVASServiceOnDemandSystematic Is Nothing Then
                Response.Redirect(ViewState("BackPage"))
                Return
            End If
            ...
            With lnqVASServiceOnDemandSystematic
                txtAggergator.Text = .tbl_VASServiceOnDemand.tbl_VASService.tbl_Aggregators.Name

                If .tbl_VASServiceOnDemand.tbl_VASService.IsPardis = True Then
                    txtIsParis.Text = "پردیس"
                    txtIMIEnduserTariff.Enabled = False
                    txtIMIEnduserTariff.Text = ""
                Else
                    txtIsParis.Text = "IMI"
                    txtIMIEnduserTariff.Text = .tbl_VASServiceOnDemand.tbl_VASService.IMIEnduserTariff
                    txtIMIEnduserTariff.Enabled = True
                End If

                cmbtheTypeDemand.SelectedValue = .tbl_VASServiceOnDemand.theType

                If .tbl_VASServiceOnDemand.theType = 3 Then 'Dynamic
                    txtKeyDemand.Enabled = False
                    txtKeyDemand.Text = ""
                Else
                    txtKeyDemand.Enabled = True
                    txtKeyDemand.Text = .tbl_VASServiceOnDemand.theKey
                End If

                txtRemarks.Text = .tbl_VASServiceOnDemand.tbl_VASService.Remarks
                txtServiceID.Text = .tbl_VASServiceOnDemand.tbl_VASService.AggergatorServiceID
                txtServiceName.Text = .tbl_VASServiceOnDemand.tbl_VASService.ServiceName
                txtServicePrice.Text = .tbl_VASServiceOnDemand.tbl_VASService.ServicePrice
                txtTextFooter.Text = .tbl_VASServiceOnDemand.tbl_VASService.FooterText
                txtTextGoodbye.Text = .tbl_VASServiceOnDemand.tbl_VASService.GoodbyeText
                txtTextHeader.Text = .tbl_VASServiceOnDemand.tbl_VASService.HeaderText
                txtTextWelcome.Text = .tbl_VASServiceOnDemand.tbl_VASService.WelcomeText
                txttheWholeNumber.Text = .tbl_VASServiceOnDemand.tbl_VASService.theWholeNumber
                txtUserOwner.Text = .tbl_VASServiceOnDemand.tbl_VASService.tbl_User.Username & " (" & .tbl_VASServiceOnDemand.tbl_VASService.tbl_User.FName & " " & .tbl_VASServiceOnDemand.tbl_VASService.tbl_User.LName & ")"
                cmbCategoryVASService.SelectedValue = .tbl_VASServiceOnDemand.tbl_VASService.FK_VASServiceCategoryID
                rdoServiceActiveYes.Checked = .tbl_VASServiceOnDemand.tbl_VASService.IsActive
                rdoServiceActiveNo.Checked = Not (.tbl_VASServiceOnDemand.tbl_VASService.IsActive)

                txtWebServiceMethod.Text = .WebServiceMethod
                txtWebServiceParameter.Text = .WebMethodOtherParameter
                txtWebServicePassword.Text = .WebMethodPassword
                txtWebServicePath.Text = .WebServicePath
                txtWebServiceUsername.Text = .WebMethodUsername
    ...
    Private Sub Bootstrap_Panel_Panel_Save_Click(sender As Object, e As EventArgs) Handles Bootstrap_Panel.Panel_Save_Click
        ...
        qryVASServiceOnDemandSystematic.tbl_VASServiceOnDemandSystematic_Update(inttheKey, strWebServicePath, strWebServiceMethod, strWebServiceUsername, strWebServicePassword, strWebServiceParameter)
