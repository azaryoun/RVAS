...
Public Class VASServiceMembershipNewsEdit
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            ...
            Dim lnqVASServiceMembershipNews = OdbVas.tbl_VASServiceMembership.Where(Function(x) x.FK_VASServiceID = inttheKey AndAlso x.IsNewsContent = True).FirstOrDefault

            If lnqVASServiceMembershipNews Is Nothing Then
                Response.Redirect(ViewState("BackPage"))
                Return
            End If
            ...
            With lnqVASServiceMembershipNews
