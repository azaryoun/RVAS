...
Public Class VASServiceMembershipNewsNew
    ...
    Private Sub Bootstrap_Panel_Panel_Save_Click(sender As Object, e As EventArgs) Handles Bootstrap_Panel.Panel_Save_Click
        ...
        qryVASServiceMembership.spr_VASServiceMembership_Insert(intVASServiceID, strKeySubscription, strKeyUnsubscription, True)
