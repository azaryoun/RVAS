<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Smart.Master" CodeBehind="ContentMembershipSerialEdit.aspx.vb" Inherits="RVAS.ContentMembershipSerialEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-xs-12">
     ...
     <div class="form-group has-warning">
            ...
            <asp:TextBox ID="txtVASServiceSerial" runat="server" ReadOnly="true" CssClass="form-control"   TextMode="SingleLine" MaxLength="40" ></asp:TextBox>
