<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Smart.Master" CodeBehind="ContentMembershipSerialManagement.aspx.vb" Inherits="RVAS.ContentMembershipSerialManagement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    function btnSerials_ClientClick(Pkey) {
        var hdnAction_Name = "<%=hdnAction.ClientID%>";
        var hdnAction = document.getElementById(hdnAction_Name);
