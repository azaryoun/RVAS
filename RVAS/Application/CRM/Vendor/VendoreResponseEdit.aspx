<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Smart.Master" CodeBehind="VendoreResponseEdit.aspx.vb" Inherits="RVAS.VendoreResponseEdit" %>
            ...
            <div class="col-xs-12">
                ...
                <!-- form start -->
                 <div class="box-body">
                    ...
                    <div class="form-group">
                      <label>ملاحظات</label>
                        <asp:TextBox ID="txtResponseRemark" runat="server" CssClass="form-control" placeholder="شرح پاسخ را وارد نمایید"  TextMode="SingleLine" MaxLength="40" ></asp:TextBox>
                      </div>
