<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Smart.Master" CodeBehind="CustomerRequestManagement.aspx.vb" Inherits="RVAS.CustomerRequestManagement" %>
                    ...
                    <thead>
                      <tr role="row">
                          ...
                          <th  style="width:100px;" >ردیف</th>
                            <th  style="width:100px;" >شماره درخواست</th>
                          <th  style="width: 228px;" >نوع</th>
                           <th  style="width: 228px;" >تارخ درخواست</th>
                           <th  style="width: 228px;" >وضعیت</th>
                           <th  style="width: 228px;" >کاربر</th>
                    ...
                    <tfoot>
                      <tr>
                          ...
                          <th rowspan="1" colspan="1">نوع</th>
                           <th rowspan="1" colspan="1">تارخ درخواست</th>
