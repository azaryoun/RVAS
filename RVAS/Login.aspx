<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Login.aspx.vb" Inherits="RVAS.Login" %>
...
<asp:CheckBox ID="chkRememberMe" runat="server" />
            ...
            <div class="col-xs-4">
     <asp:Button ID="btnSignIn" runat="server" Text="ورود به سیستم" CssClass="btn btn-primary btn-block btn-flat"/>
