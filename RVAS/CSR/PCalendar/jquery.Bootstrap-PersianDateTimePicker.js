...
(function ($) {
    ...
    function bindEvents() {
        ...
        $(document).on('keydown', 'input[type="text"][data-name^="Clock"]', function (e) {
           // alert(e.which);
            if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57) && (e.which < 96 || e.which > 105)) return false;
            return true;
        });
